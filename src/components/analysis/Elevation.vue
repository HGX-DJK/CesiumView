<template>
  <div class="container">
    <div class="button-group">
      <button class="common-btn" @click="updateMaterial">开始分析</button>
      <button class="common-btn" @click="clearMaterial">结束分析</button>
    </div>
    <div id="toolBar" style="margin:2rem">
      <table>
        <tbody>
          <tr>
          ...
          <tr>
            ...
            <td>
              <input type="range" min="200" max="1500" step="1"
          ...
          <tr>
            <td>Gradient</td>
            <td>
              <input type="checkbox" class="input-check" data-bind="checked: gradient" />
            </td>
          </tr>
        </tbody>
      </table>
